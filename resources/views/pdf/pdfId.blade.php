...
<thead>
    <tr>
        ...
        <th class="tg-7btt">FECHA <br><span style="font-weight: none;text-transform:uppercase;">{{$id->fecha_solicitud}}</span></th>
        <th class="tg-7btt">Nro° <br><span style="font-weight: none;text-transform:uppercase;">{{$id->id}}</span></th>
    </tr>
</thead>
<tbody>
    <tr>
    ...
    <tr>
        ...
        <td class="tg-fymr" colspan="2" rowspan="2">Nombre del Supervisor Inmediato: <span style="font-weight: none;text-transform:uppercase;">{{$id->supervisor}}</span></td>
    </tr>
    <tr>
        <td class="tg-fymr" colspan="3">Nombre del Solicitante: <span style="font-weight: none;text-transform:uppercase;">{{$id->nombre}}</span></td>
    </tr>
    <tr>
        <td class="tg-0pky" colspan="2"><span style="font-weight:bold">Cédula de Identidad: <span style="font-weight: none;text-transform:uppercase;">{{$id->cedula}}</span></td>
        <td class="tg-fymr">Ubicación Geográfica: <span style="font-weight: none;text-transform:uppercase;">{{$id->ubicacion}}</span></td>
    ...
    <tr>
        <td class="tg-fymr" colspan="3">Vicepresidencia o Gerencia General: <span style="font-weight: none;text-transform:uppercase;">{{$id->vicepresidencia}}</span></td>
    ...
    <tr>
        <td class="tg-0pky" colspan="2"><span style="font-weight:bold;">Gerencia: </span><span style="font-weight:none;text-transform:uppercase;">{{$id->gerencia}}</span></td>
        <td class="tg-0pky"><span style="font-weight:bold">Departamento: <span style="font-weight: none;text-transform:uppercase;">{{$id->departamento}}</span></td>
    ...
    <tr>
        <td class="tg-0pky" colspan="3" rowspan="2"><span style="font-weight:bold">Motivo del Permiso: <span style="font-weight: none;text-transform:uppercase;">{{$id->motivo}}</span></td>
    ...
    <tr>
        <td class="tg-fymr" style="width:110px;" >Desde: <span style="font-weight: none;text-transform:uppercase;">{{$id->tiempo_inicio}}</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br> Hasta: <span style="font-weight: none;">{{$id->tiempo_fin}}</span></td>
        <td class="tg-fymr">Total de Dias: <span style="font-weight: none;text-transform:uppercase;">{{$id->total_dias}}</span></td>
        <td class="tg-fymr">Total de Horas: <span style="font-weight: none;text-transform:uppercase;">{{$id->total_horas}}</span></td>
