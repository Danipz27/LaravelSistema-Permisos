...
<div class=" flex flex-col lg:flex-row w-11/12 mx-auto bg-white rounded-xl drop-shadow-xl">
    ...
    <form action="{{route('index.mostrar')}}" method="get">
        ...
        <h1 class="text-3xl font-bold mt-10">BUEN DÍA!!</h1>
        ...
        <div>
            ...
            <div class="shadow-md w-full">
                <label class="block">
                    ...
                    <input type="date" required id="fechaActual" name="fecha_solicitud" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Fecha de la Solicitud" />
                </label>
                </div><br>
                    ...
                    <div class="shadow-md w-full">
                        ...
                        <div class="grid grid-cols-2 gap-3" >
                            ...
                            <label class="block">
                                ...
                                <textarea required name="motivo" autocomplete="off" rows="3" id="id_motivo" class="placeholder:italic placeholder:text-slate-400 mb-2 mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Motivo del Permiso"></textarea>
                            </label>
                            </div>
                            <div class="px-2 py-2">
                            <label class="block">
